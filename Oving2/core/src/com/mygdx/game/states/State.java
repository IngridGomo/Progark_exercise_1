...
public abstract class State {
    protected OrthographicCamera cam; // Don't think I actually use this any longer, as I commented out teh scaling of the screen etc. in PlayState
    protected Vector3 mouse; // Don't think I actually use this for anything
    // gsm manages the state of our game. Vi har ulike game states; eks. playState, pauseState som legges oppå det. Så i stedet for å update og endre playState, så updater vi og rendrer nå pause-state. Når brukeren trykker play igjen så fjerner vi den staten og den aktive staten blir play-state. Så dette funker bra med en stack.
