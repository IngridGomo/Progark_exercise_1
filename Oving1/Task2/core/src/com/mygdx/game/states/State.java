...
public abstract class State {
    ...
    // gsm manages the state of our game. Vi har ulik egame states; eks. paly state, pause state som legges oppå det. Så i stedet for å update og endre playstate, så updater vi og rendrer nå pause-state. Når brukeren trykker play igjen så fjerner vi den staten og den aktive staten blir play-state. Så dette funker bra med en stack.
